...
# Practice set info ----
practice.begin("DS-10-5", learner="[your name]", email="[your e-mail]")
...
#    out of 1 million.) (Variable: number_in_million)
...
# i: How many babies out of 1 million had the name 'Laura' in 1995? (Variable: laura_answer)
