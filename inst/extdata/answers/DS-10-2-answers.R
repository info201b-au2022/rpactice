...
#   #       > runif(5, 10, 20) (Variable: salaries_2017) (Variable: salaries_2017)
salaries_2017 <- round(runif(100, 40000, 50000),2)

# c: A vector, named `salary_adjustments`, was also been created, with this code:
...
#       > round(runif(100, -5000, 10000),2) (Variable: salary_adjustments)
salary_adjustments <- round(runif(100, -5000, 10000),2)
